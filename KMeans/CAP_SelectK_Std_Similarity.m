...
% algorithm is repeated on the whole sample.
   ...
   % Loop over all K values to assess
    for n_k = 1:length(K_range)
        ...
        for rep = 1:reps
            ...
            IDX = kmeans(X,k,'Distance',DistType,'Replicates',10, 'MaxIter',1000, 'Start','uniform');
...
% Evaluate optimal clustering solutions:   
