...
smooth <- read.csv("../../Data/ScanTask_Data/CAP_k8_wide_smoothed_2024-03-20.csv",header=TRUE,stringsAsFactors = FALSE)

# add columns from smooth to events file:
dsmooth = cbind(events, smooth)

# smoothed CAP sequences, long format (make sure to fix dlong volume labels)
dlong <- read.csv("../../Data/ScanTask_Data/CAP_k8_long_smoothed_2024-08-12.csv",header=TRUE,stringsAsFactors = FALSE)
...
dtask <- read.csv("../../Data/ScanTask_Data/nback_raw_merge_2024-03-29.csv",header=TRUE)
